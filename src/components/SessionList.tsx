        ...
        {sessions.map((s) => {
          ...
          return (
            <button
              ...
              className={`flex cursor-pointer items-center gap-2 border-l-2 py-[7px] pr-3.5 pl-2.5 text-left hover:bg-[#140d05] ${
            ...
            >
              ...
              {s.running && (
                <span
                  title="sesión activa"
                  className="oc-blink flex-none inline-block size-[5px] bg-amber-hi shadow-[0_0_5px_rgb(255_210_122/0.8)]"
                />
              )}
